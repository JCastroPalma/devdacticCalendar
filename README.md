...
dependencies {
    implementation "ee.getid:getidlib:2.5.0"
}
```
...
GetIDSDK().startVerificationFlow(
    ...
    auth = Key("e379a4031a6b72f54299d65669850ae221ec4f1fe861ebd199fd07b26d4253ba"),
    flowName = "Laniakea27112021"
)
```
or
...
new GetIDSDK().startVerificationFlow(
                ...
                "https://laniakea.sb.getid.dev",
                new Key("e379a4031a6b72f54299d65669850ae221ec4f1fe861ebd199fd07b26d4253ba", null),
                "Laniakea27112021",
                null,
                null,
                null,
...
GetIDSDK().startVerificationFlow(
    context = applicationContext,
    apiUrl = "https://laniakea.sb.getid.dev",
    auth = Token("eyJhbGciOiJIUzI1NiIsInR...jcnJUU"),
    flowName = "Laniakea27112021"
)
```
or
...
new GetIDSDK().startVerificationFlow(
                getApplicationContext(),
                "https://laniakea.sb.getid.dev",
                new Token("eyJhbGciOiJIUzI1NiIsInR...jcnJUU"),
                "Laniakea27112021",
                null,
                null,
                null,
...
GetIDSDK().startVerificationFlow(
    ...
    apiUrl = "https://laniakea.sb.getid.dev",
    auth = Token("eyJhbGciOiJIUzI1NiIsInR...jcnJUU"),
    flowName = "https://laniakea.sb.getid.dev",
